package es.degrassi.comon.init.gui.screen.furnace;
...
public abstract class FurnaceScreen extends AbstractContainerScreen<FurnaceContainer> implements IScreen {
  ...
  protected static final ResourceLocation FILLED_ARROW = new ResourceLocation(Degrassi.MODID, "textures/gui/furnace_progress_filled.png");
