...
public class DegrassiLogger {
    ...
    public static final Logger INSTANCE = LogManager.getLogger("Degrassi");
    public static final String NAME = "Degrassi";
    ...
    public static void init() {
        ...
        RollingFileAppender cmAppender = RollingFileAppender.newBuilder()
                .withFileName("logs/degrassi.log")
                .withAppend(false)
                .withFilePattern("logs/degrassi-%i.log.gz")
                .withPolicy(policy)
