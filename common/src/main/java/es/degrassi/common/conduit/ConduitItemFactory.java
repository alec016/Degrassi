...
public class ConduitItemFactory {
  ...
  /**
   * this field is set by Degrassi during the FMLConstructModEvent.
   */
  @Nullable
  ...
  /**
   * This will create a Conduit Item. If, during porting, Degrassi isn't available, a dummy item will be returned.
   * @return
   */
