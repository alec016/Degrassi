...
public class FluidPanel<T extends ItemLike> extends ItemPanel<T> {
  public FluidPanel(Section parent) {
    super(parent);
  }

  public FluidPanel(T item, Section parent) {
    super(item, parent);
  }

  public FluidPanel(List<T> items, Section parent) {
    super(items, parent);
  }

  public FluidPanel(ItemLike[] items, Section parent) {
    super(items, parent);
  }
