...
public class SP6Entity extends SolarPanelEntity {
  private LazyOptional<IItemHandler> lazyItemHandler = LazyOptional.empty();
  private LazyOptional<AbstractEnergyStorage> lazyEnergyHandler = LazyOptional.empty();
  public SP6Entity(BlockPos pos, BlockState state) {
    super(
      EntityRegister.SP_TIER_6.get(),
      pos,
      state,
      Component.translatable("block.degrassi.solar_panel_tier_6"),
      DegrassiConfig.get().solarPanelConfig.sp6_capacity,
      DegrassiConfig.get().solarPanelConfig.sp6_transfer
    );
  ...
  public int getGeneration() {
    return DegrassiConfig.get().solarPanelConfig.sp6_generation;
  }
