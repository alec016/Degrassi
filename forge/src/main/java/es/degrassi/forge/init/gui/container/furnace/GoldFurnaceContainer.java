...
public class GoldFurnaceContainer extends FurnaceContainer {
  protected GoldFurnaceContainer(int i, Inventory inv, FurnaceEntity entity, ContainerData data) {
    super(ContainerRegistry.GOLD_FURNACE_CONTAINER.get(), i, entity, inv);
    this.data = data;
  ...
  public GoldFurnaceContainer(int id, Inventory inv, FurnaceEntity entity) {
    this(id, inv, entity, new SimpleContainerData(4));
  }

  public GoldFurnaceContainer(int id, Inventory playerInv, @NotNull FriendlyByteBuf extraData) {
    this(
      id,
      playerInv,
  ...
  public Component getId() {
    return Component.literal("Gold Furnace Container");
  }
}
