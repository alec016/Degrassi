...
public class NetheriteFurnaceContainer extends FurnaceContainer {
  protected NetheriteFurnaceContainer(int i, Inventory inv, FurnaceEntity entity, ContainerData data) {
    super(ContainerRegistry.NETHERITE_FURNACE_CONTAINER.get(), i, entity, inv);
    this.data = data;
  ...
  public NetheriteFurnaceContainer(int id, Inventory inv, FurnaceEntity entity) {
    this(id, inv, entity, new SimpleContainerData(4));
  }

  public NetheriteFurnaceContainer(int id, Inventory playerInv, @NotNull FriendlyByteBuf extraData) {
    this(
      id,
      playerInv,
  ...
  public Component getId() {
    return Component.literal("Netherite Furnace Container");
  }
}
