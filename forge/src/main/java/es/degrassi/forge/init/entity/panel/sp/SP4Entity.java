...
public class SP4Entity extends SolarPanelEntity {
  private LazyOptional<IItemHandler> lazyItemHandler = LazyOptional.empty();
  private LazyOptional<AbstractEnergyStorage> lazyEnergyHandler = LazyOptional.empty();
  public SP4Entity(BlockPos pos, BlockState state) {
    super(
      EntityRegister.SP_TIER_4.get(),
      pos,
      state,
      Component.translatable("block.degrassi.solar_panel_tier_4"),
      DegrassiConfig.get().solarPanelConfig.sp4_capacity,
      DegrassiConfig.get().solarPanelConfig.sp4_transfer
    );
  ...
  public int getGeneration() {
    return DegrassiConfig.get().solarPanelConfig.sp4_generation;
  }
