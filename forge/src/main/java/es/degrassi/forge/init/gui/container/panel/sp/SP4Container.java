...
public class SP4Container extends PanelContainer {
  public SP4Container(int i, Inventory inv, PanelEntity entity, ContainerData data) {
    super(ContainerRegistry.SP4_CONTAINER.get(), i, entity, inv);
    DegrassiLogger.INSTANCE.info(entity);
    this.data = data;
  ...
  public SP4Container(int id, Inventory inv, PanelEntity entity) {
    this(id, inv, entity, new SimpleContainerData(4));
  }

  public SP4Container(int id, Inventory playerInv, @NotNull FriendlyByteBuf extraData) {
    this(
      id,
      playerInv,
