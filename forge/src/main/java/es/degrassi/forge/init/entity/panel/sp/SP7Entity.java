...
public class SP7Entity extends SolarPanelEntity {
  private LazyOptional<IItemHandler> lazyItemHandler = LazyOptional.empty();
  private LazyOptional<AbstractEnergyStorage> lazyEnergyHandler = LazyOptional.empty();
  public SP7Entity(BlockPos pos, BlockState state) {
    super(
      EntityRegister.SP_TIER_7.get(),
      pos,
      state,
      Component.translatable("block.degrassi.solar_panel_tier_7"),
      DegrassiConfig.get().solarPanelConfig.sp7_capacity,
      DegrassiConfig.get().solarPanelConfig.sp7_transfer
    );
  ...
  public int getGeneration() {
    return DegrassiConfig.get().solarPanelConfig.sp7_generation;
  }
