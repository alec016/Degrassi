...
public class SP8Container extends PanelContainer {
  public SP8Container(int i, Inventory inv, PanelEntity entity, ContainerData data) {
    super(ContainerRegistry.SP8_CONTAINER.get(), i, entity, inv);
    this.data = data;
  ...
  public SP8Container(int id, Inventory inv, PanelEntity entity) {
    this(id, inv, entity, new SimpleContainerData(4));
  }

  public SP8Container(int id, Inventory playerInv, @NotNull FriendlyByteBuf extraData) {
    this(
      id,
      playerInv,
