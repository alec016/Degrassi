...
public class SP2Container extends PanelContainer {
  public SP2Container(int i, Inventory inv, PanelEntity entity, ContainerData data) {
    super(ContainerRegistry.SP2_CONTAINER.get(), i, entity, inv);
    this.data = data;
  ...
  public SP2Container(int id, Inventory inv, PanelEntity entity) {
    this(id, inv, entity, new SimpleContainerData(4));
  }

  public SP2Container(int id, Inventory playerInv, @NotNull FriendlyByteBuf extraData) {
    this(
      id,
      playerInv,
