...
public class EmeraldFurnaceContainer extends FurnaceContainer {
  protected EmeraldFurnaceContainer(int i, Inventory inv, FurnaceEntity entity, ContainerData data) {
    super(ContainerRegistry.EMERALD_FURNACE_CONTAINER.get(), i, entity, inv);
    this.data = data;
  ...
  public EmeraldFurnaceContainer(int id, Inventory inv, FurnaceEntity entity) {
    this(id, inv, entity, new SimpleContainerData(4));
  }

  public EmeraldFurnaceContainer(int id, Inventory playerInv, @NotNull FriendlyByteBuf extraData) {
    this(
      id,
      playerInv,
  ...
  public Component getId() {
    return Component.literal("Emerald Furnace Container");
  }
}
