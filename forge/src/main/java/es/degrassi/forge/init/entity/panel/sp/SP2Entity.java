...
public class SP2Entity extends SolarPanelEntity {
  ...
  public SP2Entity(BlockPos pos, BlockState state) {
    super(
      ...
      DegrassiConfig.get().solarPanelConfig.sp2_capacity,
      DegrassiConfig.get().solarPanelConfig.sp2_transfer
    );
  ...
  public int getGeneration() {
    return DegrassiConfig.get().solarPanelConfig.sp2_generation;
  }
