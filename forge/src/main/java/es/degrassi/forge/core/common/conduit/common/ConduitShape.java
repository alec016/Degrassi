package es.degrassi.forge.core.common.conduit.common;
...
public class ConduitShape {
  ...
  private static final VoxelShape CONNECTOR = Shapes.join(
    Block.box(2.5f, 2.5f, 15.5f, 13.5f, 13.5f, 16f),
    Block.box(4.5f, 4.5f, 15f, 11.5f, 11.5f, 15.5f),
    BooleanOp.OR
  );
  private static final VoxelShape CONNECTION = Block.box(7f, 7f, 9.5, 9f, 9f, 16);
