...
import static es.degrassi.forge.core.common.conduit.client.ConduitClientSetup.BOX;
import static es.degrassi.forge.core.common.conduit.client.ConduitClientSetup.CONDUIT_CONNECTION;
import static es.degrassi.forge.core.common.conduit.client.ConduitClientSetup.CONDUIT_CONNECTION_BOX;
import static es.degrassi.forge.core.common.conduit.client.ConduitClientSetup.CONDUIT_CONNECTOR;
import static es.degrassi.forge.core.common.conduit.client.ConduitClientSetup.CONDUIT_CORE;
import static es.degrassi.forge.core.common.conduit.client.ConduitClientSetup.CONDUIT_FACADE;
import static es.degrassi.forge.core.common.conduit.client.ConduitClientSetup.CONDUIT_IO_IN;
import static es.degrassi.forge.core.common.conduit.client.ConduitClientSetup.CONDUIT_IO_IN_OUT;
import static es.degrassi.forge.core.common.conduit.client.ConduitClientSetup.CONDUIT_IO_OUT;
import static es.degrassi.forge.core.common.conduit.client.ConduitClientSetup.CONDUIT_IO_REDSTONE;
import static es.degrassi.forge.core.common.conduit.client.ConduitClientSetup.modelOf;
import es.degrassi.forge.core.common.conduit.common.Area;
...
import es.degrassi.forge.core.common.conduit.common.blockentity.ConduitConnection;
import es.degrassi.forge.core.common.conduit.common.blockentity.OffsetHelper;
import es.degrassi.forge.core.common.conduit.common.blockentity.connection.DynamicConnectionState;
import es.degrassi.forge.core.common.conduit.common.blockentity.connection.IConnectionState;
...
public class ConduitBlockModel implements IDynamicBakedModel {
    ...
    public TextureAtlasSprite getParticleIcon() {
        return DegrassiModel.getMissingTexture();
    }
