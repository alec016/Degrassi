...
public class InputBusScreen extends MachineScreen<InputBusContainer> {

  public InputBusScreen(InputBusContainer menu, Inventory playerInventory, Component title) {
