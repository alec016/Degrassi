...
import es.degrassi.forge.core.common.conduit.common.menu.SyncedMenu;
...
public abstract class DegrassiScreen<T extends AbstractContainerMenu> extends AbstractContainerScreen<T> implements IScreen {
  ...
  protected DegrassiScreen(T pMenu, Inventory pPlayerInventory, Component pTitle) {
    this(pMenu, pPlayerInventory, pTitle, false);
  }

  protected DegrassiScreen(T pMenu, Inventory pPlayerInventory, Component pTitle, boolean renderLabels) {
