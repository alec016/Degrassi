...
public class EntityRegistration {
  ...
  public static final RegistrySupplier<BlockEntityType<FurnaceEntity>> GOLD_FURNACE = ENTITIES.register(
    "gold_furnace",
    () -> BlockEntityType.Builder.of(
  ...
  public static final RegistrySupplier<BlockEntityType<FurnaceEntity>> DIAMOND_FURNACE = ENTITIES.register(
    "diamond_furnace",
    () -> BlockEntityType.Builder.of(
  ...
  public static final RegistrySupplier<BlockEntityType<FurnaceEntity>> EMERALD_FURNACE = ENTITIES.register(
    "emerald_furnace",
    () -> BlockEntityType.Builder.of(
  ...
  public static final RegistrySupplier<BlockEntityType<FurnaceEntity>> NETHERITE_FURNACE = ENTITIES.register(
    "netherite_furnace",
    () -> BlockEntityType.Builder.of(
