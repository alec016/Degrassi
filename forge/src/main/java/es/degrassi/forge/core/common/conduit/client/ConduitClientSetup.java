package es.degrassi.forge.core.common.conduit.client;

import es.degrassi.forge.Degrassi;
import es.degrassi.common.conduit.ConduitTypes;
import es.degrassi.common.misc.ColorControl;
import es.degrassi.forge.core.common.conduit.client.model.ConduitGeometry;
...
public class ConduitClientSetup {
  ...
  private static ResourceLocation loc(String modelName) {
    ResourceLocation loc = Degrassi.rl(modelName);
