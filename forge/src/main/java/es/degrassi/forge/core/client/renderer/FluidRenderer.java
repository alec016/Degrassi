...
import es.degrassi.common.utils.AngleHelper;
import es.degrassi.common.utils.TransformStack;
...
public class FluidRenderer {
  ...
  static class RenderTypes extends RenderStateShard {
    private static final RenderType FLUID = RenderType.create(Degrassi.MODID + ":" + "fluid",
