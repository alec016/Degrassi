...
public class ItemRegistration {
  ...
  public static final VarReg<PhotovoltaicCell, Item> PHOTOVOLTAIC_CELL = register(ITEMS, "photovoltaic_cell", PhotovoltaicCellItem::new, PhotovoltaicCell.getNormalizedVariants());
