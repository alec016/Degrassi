...
import es.degrassi.forge.core.common.conduit.client.gui.IFullScreenListener;
import es.degrassi.forge.core.common.conduit.client.gui.IScreen;
...
public class EnumIconWidget<T extends Enum<T> & IIcon, U extends Screen & IScreen> extends AbstractWidget implements IFullScreenListener {
  ...
  public void renderWidget(GuiGraphics guiGraphics, int pMouseX, int pMouseY, float pPartialTicks) {
    ...
    IScreen.renderIcon(guiGraphics, new Vector2i(getX(), getY()), icon);
  ...
  private class SelectionWidget extends AbstractWidget {
    ...
    public void renderWidget(GuiGraphics guiGraphics, int pMouseX, int pMouseY, float pPartialTicks) {
      ...
      IScreen.renderIcon(guiGraphics, new Vector2i(getX(), getY()), value);
