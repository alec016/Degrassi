...
public class FluidInputTankScreen extends MachineScreen<FluidInputTankContainer> {

  public FluidInputTankScreen(FluidInputTankContainer menu, Inventory playerInventory, Component title) {
