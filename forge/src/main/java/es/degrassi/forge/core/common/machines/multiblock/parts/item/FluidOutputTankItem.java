...
public class FluidOutputTankItem extends BlockItem implements IVariantEntry<MultiblockPartStorage.Fluid.Output, FluidOutputTank>, InfoBox.IInfoBoxHolder {
  public FluidOutputTankItem(FluidOutputTank block, Properties properties) {
  ...
  @Override
  public FluidOutputTank getBlock() {
    return (FluidOutputTank) super.getBlock();
  }
  ...
  @Override
  public MultiblockPartStorage.Fluid.Output getVariant() {
  ...
  public InfoBox getInfoBox(ItemStack stack, InfoBox box) {
    ...
    box.set(Component.translatable("info.degrassi.max.o"),
