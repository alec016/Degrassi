package es.degrassi.forge.core.common.machines.multiblock.controller.block.entity.recipe.serializer;
...
public class MelterRecipeSerializer extends MultiblockRecipeSerializer<MelterRecipe> {
  @Override
  public MelterRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
  ...
  @Override
  public @Nullable MelterRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
  ...
  @Override
  public void toNetwork(FriendlyByteBuf buffer, MelterRecipe recipe) {
