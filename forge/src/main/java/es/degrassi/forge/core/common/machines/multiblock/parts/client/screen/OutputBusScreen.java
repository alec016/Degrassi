...
public class OutputBusScreen extends MachineScreen<OutputBusContainer> {

  public OutputBusScreen(OutputBusContainer menu, Inventory playerInventory, Component title) {
