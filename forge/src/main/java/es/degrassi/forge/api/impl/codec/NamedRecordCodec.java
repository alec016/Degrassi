...
public class NamedRecordCodec<O, F> implements App<NamedRecordCodec.Mu<O>, F> {
    ...
    public static <O, F> NamedRecordCodec<O, F> unbox(final App<Mu<O>, F> box) {
    ...
    public static <O> NamedMapCodec<O> create(final Function<Instance<O>, ? extends App<Mu<O>, O>> builder, String name) {
