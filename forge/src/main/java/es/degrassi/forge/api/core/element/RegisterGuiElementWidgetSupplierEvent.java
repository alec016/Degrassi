...
public class RegisterGuiElementWidgetSupplierEvent {
    ...
    private final Map<ElementType<?>, IGuiElementWidgetSupplier<?>> widgetSuppliers = new HashMap<>();

    public <E extends IGuiElement> void register(ElementType<E> type, IGuiElementWidgetSupplier<E> widgetSupplier) {
    ...
    public Map<ElementType<?>, IGuiElementWidgetSupplier<?>> getWidgetSuppliers() {
