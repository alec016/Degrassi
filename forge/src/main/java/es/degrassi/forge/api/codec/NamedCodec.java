...
import es.degrassi.forge.api.impl.codec.EnhancedEitherCodec;
import es.degrassi.forge.api.impl.codec.EnhancedListCodec;
import es.degrassi.forge.api.impl.codec.EnumCodec;
import es.degrassi.forge.api.impl.codec.EnumMapCodec;
import es.degrassi.forge.api.impl.codec.FieldCodec;
import es.degrassi.forge.api.impl.codec.NamedMapCodec;
import es.degrassi.forge.api.impl.codec.NamedRecordCodec;
import es.degrassi.forge.api.impl.codec.NumberCodec;
import es.degrassi.forge.api.impl.codec.OptionalFieldCodec;
import es.degrassi.forge.api.impl.codec.PairCodec;
